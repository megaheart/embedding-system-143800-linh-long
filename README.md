...
Trò chơi này chạy trên một vi điều khiển 8051 và là một trò chơi vượt chướng ngại vật với người chơi điều khiển một chiếc xe, cố gắng di chuyển qua một bản đồ thay đổi liên tục có đầy chướng ngại vật. Mục tiêu là tránh va chạm với chướng ngại vật và đi được thật xa để được điểm càng cao. Trò chơi có chướng ngại vật và nhiều loại item được biểu thị bằng các ký hiệu khác nhau, bao gồm item xóa tường gần nhất, item giảm tốc và cho item tăng tốc.
...
- Nguyễn Duy Long:
    - Phụ trách phần cơ chế tăng tốc, giảm tốc, xóa tường gần nhất.
    - Phụ trách phần sinh vật phẩm tăng tốc, giảm tốc, xóa tường gần nhất.
...
- Xe khi tăng tốc:
   ...
   Xe có tốc độ nhanh hơn bình thường.

- Xe khi giảm tốc:
   
   ![Alt text](image/image-3.png)
   
   Xe có tốc độ chậm hơn bình thường.
...
- Vật phẩm tăng tốc:
   ...
   Tăng tốc độ của xe lên 1.3 lần.

- Vật phẩm giảm tốc:

   ![Alt text](image/image-5.png)

   Giảm tốc độ của xe xuống 1.3 lần.

- Vật phẩm xóa tường gần nhất:
...
3. **Cơ chế trò chơi:**
   - Bản đồ trò chơi thay đổi liên tục liên tục từ phải qua trái, xuất hiện các chướng ngại vật hoặc item tăng tốc, giảm tốc, xóa tường gần nhất ngẫu nhiên.
   - Va chạm với chướng ngại vật dẫn đến kết thúc game.
   - Thu thập item tăng tốc, giảm tốc, xóa tường gần nhất để nhận được hiệu ứng tăng tốc độ, giảm tốc độ và xóa một chướng ngại vật phía trước.
...
### b. `randomNewObstacle()`:
- **Chức năng**: Tạo ra một chướng ngại vật hoặc vật phẩm mới trên bản đồ.
- **Cách thức hoạt động**: Dựa trên trạng thái hiện tại của `map`, hàm quyết định sinh ra chướng ngại vật hoặc vật phẩm mới, có thể là trống, vị trí chéo hoặc thẳng so với chướng ngại vật trước.
...
- **Cách thức hoạt động**: Sinh ra chướng ngại vật hoặc vật phẩm mới, cập nhật các loại chướng ngại vật và vật phẩm, và kiểm tra va chạm.
...
###3. **Vòng Lặp Trò Chơi**:
   ...
   - Vòng lặp hàm `TIMER0_ISR()` (Lặp lại sau mỗi 0.75s nếu xe đi với tốc độ nhanh, 1.25s nếu xe đi với tốc độ chậm, 1s nếu xe đi với tốc độ bình thường):
      - B1: Sinh phần tiếp theo của bản đồ và di chuyển bản đồ về phía trước.
      - B2: Kiểm tra xem xe có va chạm vào vật phẩm nào (tăng tốc, giảm tốc, xóa tường gần nhất) hay không? Nếu có thì thực hiện hiệu ứng của vật phẩm đó cũng như thay đổi icon xe theo trạng thái tương ứng. 
      - B3: Kiểm tra xem xe có va chạm với chướng ngại vật hay không? Nếu có thì kết thúc trò chơi. Nếu không thì sang bước 4.
